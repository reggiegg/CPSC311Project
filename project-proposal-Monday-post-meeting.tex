...
\maketitle
\begin{abstract}
Factor is a richly featured stack-based, concatenative language that none of us has studied before. We will explore the concatenative paradigm by writing a substantial program in Factor. This document explains the different milestones that we will achieve in our pursuit of Factor knowledge.
\end{abstract}
